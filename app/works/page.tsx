    ...
    return (
        <MainContent>
            <Document>
                ...
                <p><Image id={styles.imageTurtle} className={styles.worksImage} src={TurtleImage} alt="Turtle Graphics Image" priority /></p>
            ...
            <Document>
                <h2>LaCC</h2>
                <p><Image id={styles.imageLaCC} className={styles.worksImage} src={LaCCImage} alt="LaCC Image" /></p>
            ...
            <Document>
                <h2>ShilitoriJS</h2>
                <p><Image id={styles.imageShilitori} className={styles.worksImage} src={ShilitoriImage} alt="Shilitori Image" /></p>
            ...
            <Document>
                <h2>Portfolio</h2>
                <p><Image id={styles.imagePortfolio} className={styles.worksImage} src={PortfolioImage} alt="Portfolio Image" priority /></p>
                <p>今ご覧いただいているポートフォリオです．</p>
                <p>React, Next.js, particles.js, Vercel を用いて作成しています．</p>
            </Document>
            <Document>
                <h2>EasyTurtle</h2>
                <p><Image id={styles.imageEasyTurtle} className={styles.worksImage} src={EasyTurtleImage} alt="EasyTurtle Image" /></p>
            ...
            <Document>
                ...
                <p><Image id={styles.imageLSB} className={styles.worksImage} src={LsbImage} alt="LSB Image" /></p>
            ...
            <Document>
                <h2>TkWidgets</h2>
                <p><Image id={styles.imageTkWidgets} className={styles.worksImage} src={TkWidgetsImage} alt="TkWidgets Image" /></p>
