...
const Header = (props: HeaderProps) => {
    ...
    return (
        <div className={styles.header}>
            <Link href="/" legacyBehavior><a className={styles.headerTitle}>Latte72</a></Link>
            <svg className={`${styles.hamburgerMenu} ${props.isOpen ? styles.open : ""}`} viewBox="0 0 500 500" onClick={() => props.setIsOpen(!props.isOpen)} ref={buttonRef}>
